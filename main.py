...
def api_translate(text, to_lang, key):
    ...
    extra = ""
    if to_lang == "tr":
        extra = " Use direct Turkish; do not add hedging (no muhtemelen, belki, sanırım, olabilir, gibi görünüyor, büyük ihtimalle). For comma-separated keyword lists, translate each term plainly without adding qualifiers."
    return groq_text(
        f"Translate to {lang}. Keep it natural and professional.{extra} Return ONLY the translation:\n\n{text}",
        key, 350)
