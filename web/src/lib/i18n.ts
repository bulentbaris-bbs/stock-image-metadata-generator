...
const STRINGS: Record<string, Dict> = {
  ...
  gemini_key_tip: {
    en: 'Required for title, description, and keyword generation. Get a key at aistudio.google.com.',
    tr: 'Başlık, açıklama ve anahtar kelime üretimi için zorunludur. aistudio.google.com adresinden key alabilirsiniz.',
    de: 'Erforderlich für Titel-, Beschreibungs- und Keyword-Generierung. Key unter aistudio.google.com erhältlich.',
    es: 'Obligatoria para generar título, descripción y palabras clave. Obtén una clave en aistudio.google.com.',
    fr: "Obligatoire pour générer le titre, la description et les mots-clés. Obtenez une clé sur aistudio.google.com.",
    ru: 'Обязателен для генерации заголовка, описания и ключевых слов. Ключ можно получить на aistudio.google.com.',
    zh: '生成标题、描述和关键词时为必填项。可在 aistudio.google.com 获取密钥。',
  },
  gemini_key_required_note: {
    en: 'Required field — needed for title, description, and keyword generation.',
    tr: 'Zorunlu alan — başlık, açıklama ve anahtar kelime üretimi için gereklidir.',
    de: 'Pflichtfeld — erforderlich für Titel-, Beschreibungs- und Keyword-Generierung.',
    es: 'Campo obligatorio — necesario para generar título, descripción y palabras clave.',
    fr: 'Champ obligatoire — nécessaire pour générer le titre, la description et les mots-clés.',
    ru: 'Обязательное поле — необходимо для генерации заголовка, описания и ключевых слов.',
    zh: '必填字段——生成标题、描述和关键词时需要。',
  },
  gemini_key_required_alert: {
    en: 'Gemini API key is required.',
    tr: 'Gemini API key zorunludur.',
    de: 'Gemini-API-Key ist erforderlich.',
    es: 'La clave API de Gemini es obligatoria.',
    fr: 'La clé API Gemini est obligatoire.',
    ru: 'Требуется API-ключ Gemini.',
    zh: '需要提供 Gemini API 密钥。',
  },
  ep_id_label: {
